...
| ID | 요구사항 | 설명 |
|----|----------|------|
| W-01.1 | 첫 실행 감지 | `%APPDATA%/com.tauri-ai-sse.app/config.json` 부재 시 위자드 시작 |
...
| ID | 요구사항 | 설명 |
|----|----------|------|
| M-02.1 | 저장 경로 | 기본: `%APPDATA%/com.tauri-ai-sse.app/models/` |
